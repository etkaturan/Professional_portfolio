...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:    "Web application enabling AI-assisted exploration and population of spatial hypertext knowledge graphs. NLP pipeline for Named Entity Recognition and Relation Extraction automatically structures unstructured text into Neo4j graph nodes and relationships.",
    year:           "2024",
  ...
  },
  {
    ...
    description:    "Desktop authentication app using computer vision. Registers multiple users, captures live snapshots, and grants access when face similarity exceeds a configurable threshold.",
    year:           "2023",
  ...
  },
  {
    id:             "nexus",
    name:           "Nexus 2.0",
    tagline:        "Personal AI Assistant — JARVIS-inspired",
    description:    "Personal AI assistant with amber/gold JARVIS aesthetic. Modular OOP architecture with abstract base classes and provider registry. Uses Groq for LLM and STT, Edge TTS for voice output.",
    year:           "2025",
    stack:          ["Python", "FastAPI", "React", "Tauri", "Groq", "Edge TTS"],
    stackHighlight: ["Python", "FastAPI", "Tauri", "Groq"],
    githubUrl:      "https://github.com/etkaturan",
    liveUrl:        undefined,
    featured:       false,
  },
  {
    id:             "all-about-english",
    name:           "All About English",
    tagline:        "English Learning Web Platform",
    description:    "Interactive English learning platform with vocabulary, grammar exercises and lessons. Deployed publicly on Vercel.",
    year:           "2025",
    stack:          ["React", "TypeScript", "Vite", "Tailwind"],
    stackHighlight: ["React", "TypeScript"],
    githubUrl:      "https://github.com/etkaturan",
...
export const liveSites = [
  {
    ...
    url:         "https://etkaturan-portfolio.vercel.app",
    description: "This portfolio — built with React, TypeScript, Vite, Tailwind CSS and Framer Motion.",
    stack:       ["React", "TypeScript", "Vite", "Tailwind"],
  },
  {
    id:          "all-about-english",
